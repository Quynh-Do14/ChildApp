...
export function convertUtcToVietnamTime(utcInput: string): string {
    console.log("utcInput", utcInput);

    // Đảm bảo chuỗi có 'Z' để JavaScript hiểu là UTC
